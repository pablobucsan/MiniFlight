...
Topic           & Routing key used by the Software Bus   & The primary value the bus matches against subscriptions \\
Source          & Identifier of the publishing component & Useful for debugging, health monitoring and tracing \\
Sequence number & Per-source (or per-topic) counter      & Helps detect gaps or reordering during demos \\
